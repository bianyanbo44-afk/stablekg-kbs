...
\textbf{c,} Exhaustive deletion of at most the indicated number of windows yields different worst-case winner margins. These values illustrate the construction and are not empirical benchmark results.}
\label{fig:interface}
\end{figure*}
